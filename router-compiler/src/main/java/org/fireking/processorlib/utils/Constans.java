...
public class Constans {
    ...
    public static final String WARNING_TIPS = "DO NOT EDIT THIS FILE!!! IT WAS GENERATED BY PROCESSOR.";
    ...
    public static final String ANNOTATION_TYPE_BINDVIEW = FACADE_PACKAGE + ".annotation.BindView";
